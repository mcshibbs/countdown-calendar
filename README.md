...
Version 1.1 adds Home/Add Event/Settings navigation, moves exports into Settings, and includes bulk import for `.ics`, JSON, and CSV files. Version 1.1.1 folds navigation into a collapsible menu and opens Add Event as a modal over the Home screen.
